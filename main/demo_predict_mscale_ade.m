...
function demo_predict_mscale_ade()
...
run_config.trained_model_path='../model_trained/refinenet_res101_ade.mat'; % resnet101 based refinenet
% run_config.trained_model_path='../model_trained/refinenet_res152_ade.mat'; % resnet152 based refinenet
...
img_data_dir='../datasets/example_imgs_ade';
...
% img_data_dir='../datasets/ade/images_testonly';
% gt_mask_dir='../datasets/ade/gt_testonly';
%-------------------------------------------------------------------------------------------------------------------------
