...
function demo_refinenet_test_example_person_parts()
...
result_dir=fullfile('../cache_data', 'test_examples_person_parts', result_name);


% the folder that contains testing images:
ds_config.img_data_dir='../datasets/example_imgs_person_parts';
...
run_config.trained_model_path='../model_trained/refinenet_res101_person_parts.mat';
ds_config.class_info=gen_class_info_person_parts();
