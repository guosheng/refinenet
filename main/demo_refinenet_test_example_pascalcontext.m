...
function demo_refinenet_test_example_pascalcontext()
...
result_dir=fullfile('../cache_data', 'test_examples_pascalcontext', result_name);


% the folder that contains testing images:
ds_config.img_data_dir='../datasets/example_imgs_pascalcontext';


% using a trained model which is trained on VOC 2012
run_config.trained_model_path='../model_trained/refinenet_res101_pascalcontext.mat';
